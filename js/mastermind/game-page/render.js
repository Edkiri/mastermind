...
export function renderRows(boardElement, rows) {
  rows.forEach((row) => {
...
export function renderSecretList(secretListElement, secretRow) {
  secretRow.secretCells.forEach((cell) => {
    const cellElement = createHTMLElement("div", "", ["cell"]);
    cellElement.style.backgroundColor = cell.color;
    secretListElement.appendChild(cellElement);
  })
}